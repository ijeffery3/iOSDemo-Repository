...
+ (instancetype)shareManager
{
    ...
    static AINetworkManager * manager = nil;
...
+(void)requestWithType:(HttpRequestType)type withUrlString:(NSString *)urlString withParaments:(id)paraments withSuccessBlock:(requestSuccess)successBlock withFailureBlock:(requestFailure)failureBlock progress:(downloadProgress)progress
{
    ...
    switch (type) {
        ...
        case HttpRequestTypeGet:
        {
            ...
            [[AINetworkManager shareManager] GET:urlString parameters:paraments progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            
        {
            ...
            [[AINetworkManager shareManager] POST:urlString parameters:paraments progress:^(NSProgress * _Nonnull uploadProgress) {
...
+(void)cancelAllRequest
{
    ...
    [[AINetworkManager shareManager].operationQueue cancelAllOperations];
...
+(void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string
{
    ...
    NSString * urlToPeCanced = [[[[AINetworkManager shareManager].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
    
    
    for (NSOperation * operation in [AINetworkManager shareManager].operationQueue.operations) {
